...
class EasySocialViewConversations extends EasySocialSiteView
{
	...
	public function read()
	{
		...
		if( !$id || !$loaded )
		{
			FD::info()->set( JText::_( 'COM_EASYSOCIAL_CONVERSATIONS_ERROR_INVALID_ID' ) , SOCIAL_MSG_ERROR );
		...
		if (!$conversation->isReadable($my->id)) {
			FD::info()->set( JText::_( 'COM_EASYSOCIAL_CONVERSATIONS_NOT_ALLOWED_TO_READ' ) , SOCIAL_MSG_ERROR );
		...
		$totalSentDaily	= $model->getTotalSentDaily($my->id);
