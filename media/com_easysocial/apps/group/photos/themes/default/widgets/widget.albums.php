	...
	<div class="es-widget-body">
		<ul class="widget-list-grid">
			<?php if ($albums) { ?>
				...
				<li>
					<a class="fd-small" href="<?php echo FRoute::albums( array( 'uid' => $group->getAlias() , 'type' => SOCIAL_TYPE_GROUP ) );?>"><?php echo JText::_( 'APP_GROUP_PHOTOS_WIDGET_VIEW_ALL_ALBUMS' );?> &rarr;</a>
				</li>
			<?php } else { ?>
			<li>
				<div class="fd-small">
