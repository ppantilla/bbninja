	...
	<td style="text-align: center;padding: 40px 10px 0;">
		<div style="margin-bottom:15px;">
			<div style="font-family:Arial;font-size:32px;font-weight:normal;color:#333;display:block; margin: 4px 0">
				<?php echo JText::sprintf('APP_GROUP_DISCUSSIONS_USER_LIKES_INVOLVED_DISCUSSION', $actor); ?>
			</div>
		</div>
	</td>
</tr>
		...
		<table width="540" cellspacing="0" cellpadding="0" border="0" align="center">
			<tr>
				<td>
					...
					<p style="text-align:left;">
						<?php echo JText::sprintf('APP_GROUP_DISCUSSIONS_USER_LIKES_INVOLVED_DISCUSSION_CONTENT' , $actor );?>
					</p>
				</td>
			</tr>
		</table>
					...
					<td valign="top" style="color:#888;text-align:center;padding: 0 10px;">
						<p style="margin:0;font-size:11px;">
							<a style="
									...
									" href="<?php echo $permalink;?>"><?php echo JText::_('APP_GROUP_DISCUSSIONS_VIEW_DISCUSSION');?> &rarr;</a>
						</p>
					</td>
				</tr>
			</tbody>
