...
class SocialGroupAppGroups extends SocialAppItem
{
	...
	private function prepareJoinStream( SocialStreamItem &$item )
	{
		...
		$item->opengraph->addDescription(JText::sprintf('APP_GROUPS_GROUPS_STREAM_HAS_JOIN_GROUP', $actor->getName() ) );
	}
	...
	private function prepareMakeAdminStream( SocialStreamItem &$item )
	{
		...
		$item->opengraph->addDescription( JText::sprintf( 'APP_GROUPS_GROUPS_STREAM_PROMOTED_TO_BE_ADMIN', $actor->getName() ) );
	}
	...
	private function prepareUpdateStream( SocialStreamItem &$item )
	{
		...
		$item->opengraph->addDescription( JText::sprintf( 'APP_GROUPS_GROUPS_STREAM_UPDATED_GROUP', $actor->getName() ) );
	}
