...
class SocialEventAppGuests extends SocialAppItem
{
    ...
    public function onAfterLikeSave($likes)
    {
        ...
        // apps/user/events/guests.makeadmin.like.item
        // apps/user/events/guests.going.like.item
        // apps/user/events/guests.notgoing.like.item
        // apps/user/events/guests.makeadmin.like.involved
        // apps/user/events/guests.going.like.involved
        // apps/user/events/guests.notgoing.like.involved

        $emailOptions = array(
            'title' => 'APP_USER_EVENTS_GUESTS_EMAILS_' . strtoupper($verb) . '_LIKE_ITEM_SUBJECT',
            'template' => 'apps/user/events/guests.' . $verb . '.like.item',
        ...
        $emailOptions['template'] = 'apps/user/events/guests.' . $verb . '.like.involved';
    ...
    public function onAfterCommentSave($comment)
    {
        ...
        // apps/user/events/guests.makeadmin.comment.item
        // apps/user/events/guests.going.comment.item
        // apps/user/events/guests.notgoing.comment.item
        // apps/user/events/guests.makeadmin.comment.involved
        // apps/user/events/guests.going.comment.involved
        // apps/user/events/guests.notgoing.comment.involved

        $emailOptions = array(
            'title' => 'APP_USER_EVENTS_GUESTS_EMAILS_' . strtoupper($verb) . '_COMMENT_ITEM_SUBJECT',
            'template' => 'apps/user/events/guests.' . $verb . '.comment.item',
        ...
        $emailOptions['template'] = 'apps/user/events/guests.' . $verb . '.comment.involved';
