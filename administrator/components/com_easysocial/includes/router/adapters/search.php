...
class SocialRouterSearch extends SocialRouterAdapter
{
	...
	public function parse( &$segments )
	{
		...
		if( $total == 3 && $segments[ 0 ] == $this->translate( 'search' ) && $segments[ 1 ] == $this->translate( 'search_layout_advanced') )
		{
			$vars[ 'view' ]		= 'search';
		...
		if( $total == 2 && $segments[ 0 ] == $this->translate( 'search' ) && $segments[ 1 ] == $this->translate( 'search_layout_advanced') )
		{
			$vars[ 'view' ]		= 'search';
			$vars[ 'layout' ]	= 'advanced';
		...
		if( $total == 1 && $segments[ 0 ] == $this->translate( 'search' ) )
		{
			$vars[ 'view' ]		= 'search';
