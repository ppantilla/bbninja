...
/**
 * Component's router for groups view.
 *
 * @since	1.0
...
class SocialRouterGroups extends SocialRouterAdapter
{
	...
	public function parse( &$segments )
	{
		...
		if( $total == 2 && $segments[ 1 ] != $this->translate( 'groups_layout_create' ) )
		{
			$vars[ 'categoryid' ]	= $this->getIdFromPermalink( $segments[ 1 ] );
		}
		...
		$filters 	= array( $this->translate( 'groups_filter_all' ) , $this->translate( 'groups_filter_recent' ) , $this->translate( 'groups_filter_featured' ) , $this->translate( 'groups_filter_mine' ) );
