...
<dialog>
	...
	<title><?php echo JText::_( 'COM_EASYSOCIAL_GROUPS_DELETE_CATEGORY_DIALOG_TITLE' ); ?></title>
	<content>
		<p><?php echo JText::_( 'COM_EASYSOCIAL_GROUPS_DELETE_CATEGORY_DIALOG_CONFIRMATION' ); ?></p>
