	...
	<div class="filter-bar form-inline">
		<div class="form-group">
			<strong>
				...
				<a href="http://docs.stackideas.com/developers/translations/becoming_a_translator" class="btn btn-sm btn-es-success ml-20"><?php echo JText::_( 'COM_EASYSOCIAL_START_CONTRIBUTING' ); ?></a>
			</strong>
		</div>
	</div>
