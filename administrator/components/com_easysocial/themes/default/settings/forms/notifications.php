...
echo $settings->renderPage(
	$settings->renderColumn(
		$settings->renderSection(
			...
			$settings->renderSetting('Pagination', 'notifications.general.pagination', 'input', array('unit' => true, 'class' => 'form-control input-sm input-short text-center', 'help' => true))
		),
		$settings->renderSection(
			$settings->renderHeader('Broadcast Settings'),
			$settings->renderSetting('Enable Broadcast Popup', 'notifications.broadcast.popup', 'boolean', array('help' => true)),
	...
	$settings->renderColumn(
		$settings->renderSection(
			...
			$settings->renderSetting('Polling interval', 'notifications.friends.polling', 'input', array('unit' => true, 'class' => 'form-control input-sm input-short text-center', 'help' => true))
		),
		$settings->renderSection(
