...
<div class="row">
	...
	<div class="col-md-6">
		<div class="widget-box">
			<h3><?php echo JText::_( 'COM_EASYSOCIAL_POINTS_INSTALL_UPLOAD_CSV' );?></h3>

			<p>
				<?php echo JText::_( 'COM_EASYSOCIAL_POINTS_INSTALL_UPLOAD_CSV_DESC' );?> <?php echo JText::_( 'COM_EASYSOCIAL_POINTS_INSTALL_UPLOAD_CSV_FORMAT_DESC' );?>
			</p>
