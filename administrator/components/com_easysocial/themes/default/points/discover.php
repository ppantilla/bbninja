	...
	<div class="col-md-6">
		<div class="widget-box">
			...
			<div class="mt-20 fd-small">
				<span class="label label-danger fd-small"><?php echo JText::_( 'COM_EASYSOCIAL_FOOTPRINT_NOTE' );?>:</span> <?php echo JText::_( 'COM_EASYSOCIAL_POINTS_INSTALL_SCAN_FOOTPRINT' );?>
			</div>
